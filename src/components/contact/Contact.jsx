        ...
        <div className="container contact__container">
          <div className="contact__options">
           <article className="contact__option">
            ...
            <h4>Email</h4>
            <h5>vikrampchoudhary777@gmail.com</h5>
              <a href="mailto:vikrampchoudhary777@gmail.com"  target="__blank">Send a message</a>
           </article>
           <article className="contact__option">
              <RiMessengerLine  className="contact__option-icons"/>
            <h4>Messenger</h4>
            <h5>vikram choudhary</h5>
           ...
           <article className="contact__option">
            ...
            <h4>WhatsApp</h4>
            <h5>+916367932040</h5>
              <a href="https://api.whatsapp.com/send?phone=6367932040"   target="__blank">Send a message</a>
           </article>
          </div>
